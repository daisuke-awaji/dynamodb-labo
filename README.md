...
This is a sample template for dynamodb-labo - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name dynamodb-labo --query 'Stacks[].Outputs'
```
